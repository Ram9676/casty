...
import com.casty.music.backend.innertube.models.MusicCardShelfRenderer
...
import com.casty.music.backend.innertube.models.clean
import com.casty.music.backend.innertube.models.filterExplicit
import com.casty.music.backend.innertube.models.filterVideoSongs
import com.casty.music.backend.innertube.models.filterYoutubeShorts
                    ...
                    EpisodeItem(
                        ...
                        podcast =
                            secondaryLine.getOrNull(podcastIndex)?.firstOrNull()?.takeIf {
                                ...
                                val podcastId = it.navigationEndpoint?.browseEndpoint?.browseId ?: return@let null
                                Album(
                                    name = it.text,
                                    id = podcastId,
                                )
